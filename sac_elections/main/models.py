...
class Manifesto(models.Model):
	...
	intro = models.TextField(max_length=600, default="")
	agenda_1 = models.TextField(max_length=250, blank=True)
	agenda_2 = models.TextField(max_length=250, blank=True)
	agenda_3 = models.TextField(max_length=250, blank=True)
